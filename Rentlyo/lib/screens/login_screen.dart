...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String _getFriendlyErrorMessage(String code, String? rawMessage) {
    ...
    if (code == 'user-not-found' || msg.contains('user-not-found') || msg.contains('no user record')) {
      return 'No account found for this phone number. Please contact your property owner to set up your login account.';
    }
    if (code == 'wrong-password' || msg.contains('wrong-password') || msg.contains('password is invalid')) {
      return 'Incorrect password. Please try again carefully, or contact your property owner to reset your password.';
    }
    if (code == 'invalid-credential' || msg.contains('invalid-credential')) {
      return 'No account found for this phone number, or the password is incorrect. Please contact your property owner.';
    }
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      BrandConfig.tagline.isNotEmpty ? BrandConfig.tagline : 'Tenant Companion • LeaseSync Portal',
