...
void main() async {
  ...
  runApp(const AryaSpacesAdminApp());
}

class AryaSpacesAdminApp extends StatefulWidget {
  const AryaSpacesAdminApp({super.key});

  @override
  State<AryaSpacesAdminApp> createState() => _AryaSpacesAdminAppState();
}

class _AryaSpacesAdminAppState extends State<AryaSpacesAdminApp> with WidgetsBindingObserver {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<int>(
      ...
      builder: (context, _, __) {
        return MaterialApp(
          title: '${BrandConfig.brandName} Admin',
