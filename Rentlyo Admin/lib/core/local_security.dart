...
class LocalSecurity {
  ...
  static const String _propertyKey = 'selected_property_id';
  static DateTime? _lastPausedTime;

  static Future<String?> getSelectedPropertyId() async {
    try {
      return await _storage.read(key: _propertyKey);
    } catch (_) {
      return null;
    }
  }

  static Future<void> saveSelectedPropertyId(String propertyId) async {
    try {
      await _storage.write(key: _propertyKey, value: propertyId);
    } catch (_) {}
  }
