...
class RentScheduleItem {
  ...
  factory RentScheduleItem.fromMap(Map<String, dynamic> map) {
    ...
    if (map['effectiveFromDate'] != null && map['effectiveFromDate'] is Timestamp) {
      ...
      // Backward compat: convert month index to a date relative to epoch placeholder
      // This will be overridden at deal load time below
...
class DealModel {
  ...
  double get baseMonthlyRent {
    ...
    // Return the earliest entry's rent
